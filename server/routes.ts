...
export async function registerRoutes(
  ...
  app.post(api.auth.login.path, async (req: Request, res: Response) => {
    try {
      ...
      if (!user) {
        // Auto-register new officer/admin
  ...
  // === Requests Routes ===
  app.get(api.requests.list.path, requireAuth, async (req: Request, res: Response) => {
    const user = await storage.getUser(req.session.userId!);
  ...
  app.post(api.requests.create.path, requireAuth, async (req: Request, res: Response) => {
    try {
  ...
  app.get(api.requests.get.path, requireAuth, async (req: Request, res: Response) => {
  ...
  app.post(api.requests.reply.path, requireAuth, async (req: Request, res: Response) => {
    const user = await storage.getUser(req.session.userId!);
